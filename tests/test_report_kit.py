...
from camposcope.report_kit import images, maps, style  # noqa: E402
from camposcope.report_kit.browser_capture import JobStore, build_capture_script  # noqa: E402
from camposcope.report_kit.text import fmt_num, fmt_pct, inline_markup, t  # noqa: E402
...
def test_kit_strings_exist_in_all_four_languages():
    from camposcope.report_kit.text import LANGS, STRINGS
...
def test_locator_finds_the_uf():
    from camposcope.report_kit.locator import uf_at
