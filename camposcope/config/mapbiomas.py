...
Ported verbatim via Naturametrics from Yvynation's ``config/config.py`` and extended with Portuguese labels
(the domain is Brazilian; PT is the source language — see doc/08-ui-ux.md §7).
