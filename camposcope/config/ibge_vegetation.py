...
unchanged — the asset, taxonomy and colour map are facts about the dataset,
not about which app is asking. Used here for the SPOT/IBGE comparison tab
(doc/03-roadmap.md Phase 5 addendum), not for buffer histories.
