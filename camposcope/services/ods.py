...
**Ported verbatim from Naturametrics** (``naturametrics/services/ods.py``),
same reasoning as ``services/provenance.py``'s own note: nothing here is
Camposcope-specific, and a fix belongs upstream too.
