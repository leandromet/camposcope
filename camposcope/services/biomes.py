...
**Ported verbatim from Naturametrics** (``naturametrics/services/biomes.py``),
decision D13 — the biome overlay is navigation, not an input to any number
this app reports (doc/11-search-and-navigation.md §6). Boundaries drawn from
this layer are approximate to roughly a kilometre.
