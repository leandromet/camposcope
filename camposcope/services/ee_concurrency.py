...
**Ported verbatim from Naturametrics** (``naturametrics/services/ee_concurrency.py``), decision
D2. Nothing about this module is Camposcope-specific; if it changes here,
the change belongs upstream too.
